  ...
  return (
    <div className='Store-home'>
      <div className='Store-home-container'>
        ...
        <Product id="1" title='food of the gods' price={19.99} image='https://images-na.ssl-images-amazon.com/images/I/51OjtMiKQTL._SY291_BO1,204,203,200_QL40_FMwebp_.jpg' rating={5} />
