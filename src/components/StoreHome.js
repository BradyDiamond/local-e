  ...
  return (
    <div className='store-home'>
      <div className='store-home-container'>
        ...
        <div className='store-home-row'>
          <Product id="3" title='rubber Dog Poop' price={12.99} image='https://cdn.shopify.com/s/files/1/0201/4206/3716/products/BMHK-PO-DogPoopSafe-HideAKey-Prod-1-large_900x.jpg?v=1557261255' rating={3} />
        </div>
        ...
        <div className='store-home-row'>
          <Product id="4" title='mechanical Bull' price={19.99} image='https://ven.magicjumprentals.com/images/resampled.php?source_im=L3Zhci93d3cvdmhvc3RzL3NpdGVzMy5yZW50YWxwYWQuY29tL2h0dHBkb2NzL2NsaWVudHMvNTQvcHJvZF9pbWFnZXMvMjAxODAzMjcxNTM4NTkuanBn&w=540,200_QL40_FMwebp_.jpg' rating={3} />
          ...
          <Product id="6" title='Creed- Greatest Hits' price={6.99} image='https://i5.walmartimages.com/asr/876297eb-71c4-49a8-935c-2599401eacb5.15d5232df76a3229cdb2e7947631770c.jpeg?odnHeight=612&odnWidth=612&odnBg=FFFFFF' rating={1} />
